...
var lista1 = new Array('g45q65u');
var cadena = prompt("Introduce el codigo");
var cad = cadena.toLowerCase();
var pos = buscarItem(lista1, cad);

if (pos >=0) window.location.replace("imagen/Tachira 5 Angeris de Sanchez/Enmanuel la floresta - Tachira 5 - Grupo Enmanuel - Getsemani.pdf");
