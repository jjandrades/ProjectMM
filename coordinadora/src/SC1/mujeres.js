...
var lista1 = new Array('h4m5p4n');
var cadena = prompt("Introduce el codigo");
var cad = cadena.toLowerCase();
var pos = buscarItem(lista1, cad);

if (pos >=0) window.location.replace("imagen/San Cristobal 1 Pr. Nava/Mujeres para el reino de los cielos - San Cristobal 1 - Nueva Jerusalén.pdf");
