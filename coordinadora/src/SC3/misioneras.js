...
var lista1 = new Array('m23s89d1');
var cadena = prompt("Introduce el codigo");
var cad = cadena.toLowerCase();
var pos = buscarItem(lista1, cad);

if (pos >=0) window.location.replace("imagen/San Cristobal 3 Andrea de Barraza/Misioneras de Jesus - San Cristobal 3 - El Norte.pdf");
